...
// Input matrix dimensions
        System.out.println("Enter the number of rows and columns of thematrix:");
...
// Input non-zero elements
        System.out.println("Enter the row, column, and value for each non-zeroelement:");
